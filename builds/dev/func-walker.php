<?php
/**
 * Custom Nav Menu Walker for more accessible menus
 *
 * @package WordPress
...
/**
 * Detects if the class 'menu-item-has-children' is present
 *
...
*     The HTML attributes applied to the menu item's `<a>` element, empty strings are ignored.
	...
	*/
		...
		if ( jldc_walker_issubmenu( $item ) === true ) {
